...
namespace SDL
{
	...
	public:
		...
		// create textures
		void createTextSprite(const char* content, SDL_Color color);
		void createTextSpriteWrapped(const char* content, SDL_Color color);
		void createTextSprite(const char* content, SDL_Color fgColor, SDL_Color bgColor);
		void createSprite(const char* file);
		...
		// basic draw methods -- not operating consistently rn
